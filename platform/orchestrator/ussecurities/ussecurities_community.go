...
// Package ussecurities is the US securities compliance module.
//
// This file is the COMMUNITY build: the SEC/FINRA examination package is an
...
// compliance modules' community stubs (usbanking/usbanking_community.go,
// usinsurance/usinsurance_community.go): the edition gate is the build tag, not
...
// TestCommunityStubCoversRunGoSurface in ussecurities_community_test.go.
...
func (m *Module) HealthCheck() map[string]string {
	return map[string]string{
		"ussecurities_evidence": "disabled",
	}
}
