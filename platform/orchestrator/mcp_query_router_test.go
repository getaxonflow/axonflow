...
// orgScopeOf falls back to the tenant id, and the v10 decision shadow (retired
// in v11) refused every observation on the `mcp` plane as "an org scope but no
// org id". Ten of ten on
