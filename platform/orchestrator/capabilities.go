...
func getPluginCompatibility() PluginCompatInfo {
	return PluginCompatInfo{
		...
		// claude-code bumped 1.6.0 -> 1.7.0 in the 9.2.2 release-train
		// (ships with the v9.2.2 platform patch; the 1.7.0 marketplace
		// release fires immediately after the tag); cursor/codex/openclaw
		// unchanged. MinPluginVersion floor stays 1.4.0 / 2.4.0. Mirrors
