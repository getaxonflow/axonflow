...
// Package indonesia provides Indonesia-specific PII detection for OJK/BI/UU PDP compliance.
// Community edition: pattern-based detection only (no province-code lookup or check-digit validation).
// Enterprise edition: full validation with 34-province lookup, NIK date validation, and NPWP check digit.
package indonesia
...
// NewIndonesiaPIIDetector creates an Indonesia PII detector with the given config.
...
// DetectAll scans text for all Indonesia-specific PII types.
