...
func getPluginCompatibility() PluginCompatInfo {
	return PluginCompatInfo{
		...
		// claude/cursor/codex to 1.5.3 during the v8.5.2 release-train —
		...
		// openclaw stays 2.6.1 (no change this train). Plugin tags are live
		// on their registries (openclaw 2.6.1 on npm, claude/cursor/codex
		// 1.5.3 on ClawHub) — plugins below the recommended version receive
