...
// middleware's own behaviour is already pinned in shared/identity
// (TestSyntheticProbeHeaderIsAPositiveMembershipTest). What is unproven without
// this is that the binary uses it.
