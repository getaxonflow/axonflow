...
```
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│  Your App       │───▶│   AxonFlow      │───▶│  LLM Provider   │
│  (SDK)          │    │  Agent (8080)   │    │  (OpenAI/etc)   │
└─────────────────┘    └─────────────────┘    └─────────────────┘
                               │
                    ┌──────────┴──────────┐
                    ▼                     ▼
           ...
           │  - PII Detection│   │  - Immutable    │
           │  - RBAC/ABAC    │   │  - Exportable   │
           │  - Rate Limiting│   │  - Compliance   │
           └─────────────────┘   └─────────────────┘
```

**Key Components:**
- **Agent** (port 8080): Policy enforcement, PII detection, audit logging
- **Orchestrator** (port 8081): LLM routing, cost optimization, failover
