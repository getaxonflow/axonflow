...
cargo add axonflow-sdk-rust       # Rust (preview, v0.4.0)
```
...
The Rust SDK is at v0.4.0 preview on [crates.io](https://crates.io/crates/axonflow-sdk-rust). Repo: [axonflow-sdk-rust](https://github.com/getaxonflow/axonflow-sdk-rust).
