# License Rework E2E — claude (issue #1885)

**Generated:** 2026-05-05T11:48:36Z
**Stack:** `axonflow-community-saas-staging-20260505-103251`
**Agent:** `https://try-staging.getaxonflow.com`
**Client header:** `claude-code-plugin/1.1.0`
...
- ✅ PASS: §5.0 — minted Pro token (jti=7d6b0616-d9d5-43a7-9759-3de7979bab84) for revocation test
- ✅ PASS: §5.1 — Pro request authenticated pre-revocation (HTTP 200)
- ✅ PASS: §5.2 — DB UPDATE: revoked_at=NOW() applied at 11:49:11Z
...
- **PASS:** 22
- **FAIL:** 0
- **Plugin:** `claude-code-plugin/1.1.0`
