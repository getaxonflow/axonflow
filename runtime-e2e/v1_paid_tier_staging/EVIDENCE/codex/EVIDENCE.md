# License Rework E2E — codex (issue #1885)

**Generated:** 2026-05-05T11:50:55Z
**Stack:** `axonflow-community-saas-staging-20260505-103251`
**Agent:** `https://try-staging.getaxonflow.com`
**Client header:** `codex-plugin/1.1.0`
...
- ✅ PASS: §5.0 — minted Pro token (jti=d6b164f8-2ff9-46e4-873c-fe727513e07e) for revocation test
- ✅ PASS: §5.1 — Pro request authenticated pre-revocation (HTTP 200)
- ✅ PASS: §5.2 — DB UPDATE: revoked_at=NOW() applied at 11:51:31Z
