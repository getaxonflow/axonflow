# License Rework E2E — openclaw (issue #1885)

**Generated:** 2026-05-05T11:47:25Z
**Stack:** `axonflow-community-saas-staging-20260505-103251`
**Agent:** `https://try-staging.getaxonflow.com`
**Client header:** `openclaw/2.1.0`
...
- ✅ PASS: §5.0 — minted Pro token (jti=a3347c0d-8077-4146-b7a8-30e7f1aede9f) for revocation test
- ✅ PASS: §5.1 — Pro request authenticated pre-revocation (HTTP 200)
- ✅ PASS: §5.2 — DB UPDATE: revoked_at=NOW() applied at 11:48:01Z
- ✅ PASS: §5.3 — revoked token rejected with 401 + license_not_found_or_revoked (latency=4s)
- ✅ PASS: §5.4 — revocation latency 4s ≤ 60s ADR-049 §2 contract
