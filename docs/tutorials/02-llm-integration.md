...
AxonFlow v4.2.0 supports pluggable LLM providers. Configure the provider in your AxonFlow deployment, then send queries through the standard SDK interface.
