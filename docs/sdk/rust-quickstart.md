...
**SDK Status:** Preview (v0.2.0) | **Platform Version:** v7.6.x

> The Rust SDK is in **preview**. v0.2.0 covers a subset of the surface available in the established Go / Python / TypeScript / Java SDKs — see [SDK Feature Coverage](../SDK_FEATURE_COVERAGE.md) for the full matrix. Track upcoming work on the [Rust SDK issues](https://github.com/getaxonflow/axonflow-sdk-rust/issues) page.
...
The Rust SDK is being filled out incrementally. v0.2.0 ships the foundation (auth, proxy, audit, basic MAP, basic MCP). Coming in subsequent releases:
