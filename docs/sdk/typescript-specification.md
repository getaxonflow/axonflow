...
- **`VERSION`** -- SDK version string (`'3.4.0'`).
...
*This specification describes the AxonFlow TypeScript SDK v3.4.0 API surface. For architecture details, see [TypeScript Architecture](typescript-architecture.md). For a quick-start guide, see [TypeScript Quickstart](typescript-quickstart.md).*
