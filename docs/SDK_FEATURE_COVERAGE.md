...
| Method | Description | Status |
|--------|-------------|--------|
| `failWorkflow()` | Fail a workflow with optional reason | ✅ All SDKs (v3.6.0) |
...
| Method | Description | Status |
|--------|-------------|--------|
| `listHITLQueue()` | List pending approval requests | ✅ All SDKs (v3.6.0) |
| `getHITLRequest()` | Get approval request details | ✅ All SDKs (v3.6.0) |
| `approveHITLRequest()` | Approve a HITL request | ✅ All SDKs (v3.6.0) |
| `rejectHITLRequest()` | Reject a HITL request | ✅ All SDKs (v3.6.0) |
| `getHITLStats()` | Get HITL queue statistics | ✅ All SDKs (v3.6.0) |

#### SSE Streaming
| Method | Description | Status |
|--------|-------------|--------|
| `streamExecutionStatus()` | SSE streaming for real-time execution monitoring. Community: 5 concurrent connections/tenant | ✅ All SDKs (v3.6.0) |
...
> **Note:** HITL Queue API is now available in all SDKs (v3.6.0) via `/api/v1/hitl/queue` endpoints:
