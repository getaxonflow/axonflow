-- Migration 046: Expand llm_provider_configs provider name constraint
-- Date: 2026-02-04
-- Purpose: Keep runtime-config provider validation aligned with supported SDK providers
...
BEGIN
    ...
    IF NOT table_exists THEN
        RAISE NOTICE 'Migration 046: llm_provider_configs table does not exist. Skipping.';
        RETURN;
    END IF;
    ...
    RAISE NOTICE 'Migration 046: Updated llm_provider_configs.check_provider_name constraint';
END $migration$;
